    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "Bu bot, spotify sorgularını oynatamaz. Lütfen sahibinden spotify'ı etkinleştirmesini isteyin."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "Botla ilgili bir sorun var. Lütfen bunu sahibime bildirin ve kaydedici grubunu kontrol etmelerini isteyin."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "Lütfen Sesli Sohbeti açın. Bot, URL'leri yayınlayamaz..",
                )
            except Exception as e:
                return await mystic.edit_text(
